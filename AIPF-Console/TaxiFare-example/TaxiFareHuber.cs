...
{
    public class TaxiFareHuber : TaxiFare
    {
        private static TaxiFareHuber instance = new TaxiFareHuber();

        protected TaxiFareHuber() : base("Taxi-Fare-Huber") { }
        ...
        protected override void CreatePipeline()
        {
            mlManager.CreatePipeline()
                ...
                .Append(new ApplyEvaluableOnnxModel<ProcessedTaxiFare, PredictedFareAmount, RegressionEvaluate>(
                    $"{IExample.Dir}/TaxiFare-example/Data/Onnx/skl_hubReg.onnx",
                    (i, o) =>
                    {
